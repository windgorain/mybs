...
#define GETOPT2_FLAG_HIDE  0x1     /* 隐藏选项, help时不出现 */
#define GETOPT2_OUT_FLAG_ISSET 0x10000 /* 表示此选项被设置 */
...
enum {
    ...
    /* 常用value值类型 */
    GETOPT2_V_U32 = 'u',    /* U32 */
    GETOPT2_V_STRING = 's', /* char*, string */
    GETOPT2_V_BOOL = 'b',   /* BOOL */
    GETOPT2_V_IP = '4',
    GETOPT2_V_IP6 = '6',
    GETOPT2_V_RANGE = 'r', /* GETOPT2_NUM_RANGE_S, number range, 格式: 80 或者 100-1000 */
    GETOPT2_V_MAC = 'm',

    /* 扩展value值类型 */
    GETOPT2_V_IP_PREFIX = 256, /* IP_PREFIX_S, ip/prefix */
    GETOPT2_V_IP_PROTOCOL,        /* int, tcp/udp/icmp/17/6/1 等 */
};
